// Default Segment Tree (blaz)
// no usar #define int long long con este segtree
// para invocar el segtree:
// segment_tree<type, merge> ST(v); (se debe definir merge de antemano)
// las queries son igual que en el lazy
